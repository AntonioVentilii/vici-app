...
- **Testing**: Every change MUST include tests (or updates to existing tests). *Note: Ensure the project has a configured test runner (e.g., Vitest) before adding suites.*
