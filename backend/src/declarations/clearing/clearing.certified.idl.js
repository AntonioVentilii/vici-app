...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		...
		get_series_price_history: IDL.Func([GetSeriesPriceHistoryParams], [SeriesPriceHistory], []),
		...
		list_settled_series: IDL.Func([ListSettledSeriesParams], [SettledSeriesPage], []),
