...
| `format.utils`                                        | Number / time / address formatting. `formatToken` / `formatCurrency` / `formatQuantity` / `formatVolume` group thousands by default — never re-implement integer grouping at the call site.                                                                                                                                                                                                          |
