...
>
	<div class="space-y-3 p-6">
		<div class="flex items-start justify-between gap-2">
			<h3 class="group-hover:text-primary text-lg leading-tight font-semibold transition-colors">
				{market.title}
			</h3>
	...
	<div class="space-y-4 px-6 pb-6">
		...
		<div class="grid grid-cols-2 gap-3">
			<div class="space-y-1">
				<div class="text-muted-foreground text-xs">Yes</div>
				<div class="text-2xl font-bold text-emerald-600">
					{Math.round(market.oddsYes * 100)}¢
				</div>
			</div>
			<div class="space-y-1">
				<div class="text-muted-foreground text-xs">No</div>
		...
		<div
			class="text-muted-foreground border-border flex items-center justify-between border-t pt-2 text-xs"
		>
