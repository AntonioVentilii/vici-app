<script lang="ts">
    ...
    const handleTrade = async () => {
        ...
        try {
            ...
            toast.success(
                `Successfully placed Ꝟ ${amount} on ${selectedPosition.toUpperCase()}`,
            );
            tradeAmount = "";
...
<div class="container mx-auto px-4 py-8">
    ...
    {#if isLoading}
        <div class="space-y-6">
            <div class="h-12 w-48 bg-slate-100 animate-pulse rounded"></div>
            <div class="h-96 bg-slate-100 animate-pulse rounded"></div>
        </div>
    {:else if !market}
    ...
    {:else}
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <Card>
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div
                                class="p-6 bg-emerald-50 border-2 border-emerald-200 rounded-lg text-center"
                            >
                                <div
                            ...
                            <div
                                class="p-6 bg-rose-50 border-2 border-rose-200 rounded-lg text-center"
                            >
                                <div
                                    class="flex items-center justify-center gap-2 mb-2"
                                >
                ...
                <Card>
                    <div
                        class="p-1 border-b border-border bg-slate-100 rounded-t-md"
                    >
                        <div class="flex">
                            <button
                    ...
                    <div class="p-6">
                        {#if activeTab === "analytics"}
                            <div
                                class="h-64 flex items-center justify-center text-muted-foreground bg-slate-50 rounded"
                            >
                        ...
                        {#if !$isAuthenticated}
                            <div class="text-center py-8 space-y-4">
                                ...
                                <div>
                                    ...
                                    >
                                        Sign in to place your bets on this
                                        market
                                    </p>
                                </div>
                                <Button
                            ...
                            <div class="space-y-4">
                                <div class="space-y-2">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <Button
                                            variant={selectedPosition === "yes"
                                                ? "default"
                                                : "outline"}
                                            on:click={() =>
                                                (selectedPosition = "yes")}
                                            className={selectedPosition ===
                                            "yes"
                                        ...
                                        <Button
                                            variant={selectedPosition === "no"
                                                ? "default"
                                                : "outline"}
                                            on:click={() =>
                                                (selectedPosition = "no")}
                                            className={selectedPosition === "no"
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                >
                                <span class="font-medium underline uppercase"
                                    >{market.status}</span
                                >
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                >
                                <span class="font-medium"
                                    >{formatDate(market.createdAt)}</span
                                >
                            </div>
                            <div class="flex justify-between">
                                <span class="text-muted-foreground"
                                ...
                                >
                                <span class="font-medium"
                                    >{formatDate(market.expiration)}</span
                                >
                            </div>
                        </div>
                    </div>
