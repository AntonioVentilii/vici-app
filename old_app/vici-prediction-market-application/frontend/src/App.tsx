...
export type Page = 'home' | 'markets' | 'market-detail' | 'portfolio' | 'leaderboard' | 'learn' | 'profile' | 'admin' | 'rush' | 'wallet';
...
export default function App() {
  ...
  if (!isAuthenticated && ['portfolio', 'profile', 'admin', 'rush', 'wallet'].includes(currentPage)) {
    return (
