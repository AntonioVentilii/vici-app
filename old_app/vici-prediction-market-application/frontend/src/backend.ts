...
import type { MarketDepthPosition as _MarketDepthPosition, MarketSnapshot as _MarketSnapshot, MarketStatus as _MarketStatus, Position as _Position, PositionType as _PositionType, Time as _Time, Transaction as _Transaction, UserProfile as _UserProfile, UserRole as _UserRole, WalletBalance as _WalletBalance } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMarket(arg0: string, arg1: string, arg2: Array<string>, arg3: Time, arg4: boolean, arg5: Array<Principal>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async placePosition(arg0: bigint, arg1: PositionType, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.placePosition(arg0, to_candid_PositionType_n31(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MarketDepthPosition_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MarketDepthPosition): MarketDepthPosition {
    return from_candid_record_n22(_uploadFile, _downloadFile, value);
}
function from_candid_MarketSnapshot_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MarketSnapshot): MarketSnapshot {
    return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_MarketStatus_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MarketStatus): MarketStatus {
    return from_candid_variant_n7(_uploadFile, _downloadFile, value);
}
function from_candid_PositionType_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PositionType): PositionType {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MarketSnapshot]): MarketSnapshot | null {
    return value.length === 0 ? null : from_candid_MarketSnapshot_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PositionType]): PositionType | null {
    return value.length === 0 ? null : from_candid_PositionType_n17(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WalletBalance]): WalletBalance | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        createdAt: value.createdAt,
        user: value.user,
        positionType: record_opt_to_undefined(from_candid_opt_n28(_uploadFile, _downloadFile, value.positionType)),
        marketId: record_opt_to_undefined(from_candid_opt_n29(_uploadFile, _downloadFile, value.marketId)),
        amount: value.amount
    };
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        oddsNo: value.oddsNo,
        resolvedOutcome: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.resolvedOutcome)),
        createdAt: value.createdAt,
...
function from_candid_tuple_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, Array<_Position>]): [Principal, Array<Position>] {
    return [
        value[0],
...
function from_candid_variant_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "trade" in value ? Variant_trade_deposit_payout.trade : "deposit" in value ? Variant_trade_deposit_payout.deposit : "payout" in value ? Variant_trade_deposit_payout.payout : value;
}
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "resolved" in value ? MarketStatus.resolved : "closed" in value ? MarketStatus.closed : "open" in value ? MarketStatus.open : value;
}
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, Array<_Position>]>): Array<[Principal, Array<Position>]> {
...
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MarketDepthPosition>): Array<MarketDepthPosition> {
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MarketSnapshot>): Array<MarketSnapshot> {
    return value.map((x)=>from_candid_MarketSnapshot_n4(_uploadFile, _downloadFile, x));
}
function to_candid_PositionType_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PositionType): _PositionType {
...
function to_candid_variant_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PositionType): {
    no: null;
} | {
    yes: null;
} {
