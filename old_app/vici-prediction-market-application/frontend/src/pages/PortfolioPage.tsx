import { useGetCallerUserProfile, useGetCallerPositions, useGetCallerTransactions, useGetAllMarkets } from '../hooks/useQueries';
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">Ꝟ {Number(userProfile?.balance || 0).toLocaleString()}</div>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {positions.map((position, idx) => (
                          ...
                          >
                            <TableCell className="font-medium">{getMarketTitle(position.marketId)}</TableCell>
                            <TableCell>
