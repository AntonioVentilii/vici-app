...
ARGS_FILE="$(jq -re .canisters.vici_ledger.init_arg_file "$PROJECT_ROOT/dfx.json")"
MINTER_PRINCIPAL="${CANISTER_ID_VICI_MINTER:-$(dfx canister id vici_minter --network "$NETWORK")}"
