...
"$SCRIPTS_LIB/download-immutable.sh" \
	"https://github.com/AntonioVentilii/vici-icrc/releases/download/$VICI_ICRC_VERSION/minter.wasm.gz" \
	"$DIR/vici_minter.wasm.gz"
gunzip -f "$DIR/vici_minter.wasm.gz"

"$SCRIPTS_LIB/download-immutable.sh" \
	"https://github.com/AntonioVentilii/vici-icrc/releases/download/$VICI_ICRC_VERSION/minter.did" \
	"$DIR/vici_minter.did"
