...
CLEARING_DOMAINS_ALL="vec { variant { Playground }; variant { ViciXp } }"
...
# Register ICP (ViciXp — same domain as the in-app Playground / ViciXp experience)
echo "Registering ICP collateral asset (domains: ViciXp)..."
