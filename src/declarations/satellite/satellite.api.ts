...
const AppListLeagueBattlesResultSchema = j.strictObject({items: j.array(j.strictObject({id: j.string(), kind: j.enum(['league', 'duel']), sideA: j.string(), sideB: j.string(), proposer: j.string(), state: j.enum(['proposed', 'accepted', 'in_flight', 'resolved']), kickoffMs: j.number(), settleMs: j.number(), scope: j.optional(j.string()), wager: j.optional(j.number()), trashTalk: j.optional(j.string()), scoreA: j.optional(j.number()), scoreB: j.optional(j.number()), winner: j.optional(j.enum(['A', 'B', 'draw']))}))});
...
const AppListMyBattlesResultSchema = j.strictObject({items: j.array(j.strictObject({id: j.string(), kind: j.enum(['league', 'duel']), sideA: j.string(), sideB: j.string(), proposer: j.string(), state: j.enum(['proposed', 'accepted', 'in_flight', 'resolved']), kickoffMs: j.number(), settleMs: j.number(), scope: j.optional(j.string()), wager: j.optional(j.number()), trashTalk: j.optional(j.string()), scoreA: j.optional(j.number()), scoreB: j.optional(j.number()), winner: j.optional(j.enum(['A', 'B', 'draw']))}))});
...
const AppLookupReferralCodeByHandleArgsSchema = j.strictObject({handle: j.string()});
const AppLookupReferralCodeByHandleResultSchema = j.strictObject({code: j.optional(j.string())});

const lookupReferralCodeByHandle = async (args: j.infer<typeof AppLookupReferralCodeByHandleArgsSchema>): Promise<j.infer<typeof AppLookupReferralCodeByHandleResultSchema>> => {
	const parsedArgs = AppLookupReferralCodeByHandleArgsSchema.parse(args);
	const idlArgs = schemaToIdl({schema: AppLookupReferralCodeByHandleArgsSchema, value: parsedArgs}) as Parameters<SatelliteActor['app_lookup_referral_code_by_handle']>[0];

	const {app_lookup_referral_code_by_handle} = await getSatelliteExtendedActor<SatelliteActor>({idlFactory});
	const idlResult = await app_lookup_referral_code_by_handle(idlArgs);

	const result = schemaFromIdl({schema: AppLookupReferralCodeByHandleResultSchema, value: idlResult});
	return AppLookupReferralCodeByHandleResultSchema.parse(result);
};
...
const AppTrackEventsArgsSchema = j.strictObject({events: j.array(j.strictObject({name: j.enum(['session_started', 'signed_up', 'signed_in', 'signed_out', 'provider_linked', 'onboarding_started', 'onboarding_step', 'handle_checked', 'onboarding_completed', 'flow_session_started', 'flow_swipe', 'flow_card_expanded', 'flow_completed', 'flow_abandoned', 'sound_toggled', 'market_viewed', 'market_searched', 'market_shared', 'watchlist_added', 'watchlist_removed', 'orderbook_viewed', 'position_taken', 'position_closed', 'prediction_created', 'order_placed', 'order_cancelled', 'resolution_proposed', 'resolution_confirmed', 'resolution_disputed', 'payout_settled', 'referral_sent', 'referral_link_copied', 'referral_redeemed', 'referral_converted', 'vxp_awarded', 'streak_milestone', 'faucet_claimed', 'league_created', 'league_joined', 'league_invite_sent', 'battle_proposed', 'battle_accepted', 'battle_resolved', 'comment_posted', 'chat_sent', 'affiliation_set', 'affiliation_removed', 'school_picker_opened', 'school_picked', 'school_verify_email_submitted', 'school_verify_code_submitted', 'delete_flow_opened', 'delete_confirmed', 'delete_succeeded', 'exit_signal', 'app_error', 'perf_metric']), sessionId: j.string(), path: j.optional(j.string()), marketId: j.optional(j.string()), seriesId: j.optional(j.string()), leagueId: j.optional(j.string()), battleId: j.optional(j.string()), source: j.optional(j.string()), label: j.optional(j.string()), step: j.optional(j.number()), value: j.optional(j.number()), count: j.optional(j.number()), durationMs: j.optional(j.number()), ok: j.optional(j.boolean()), occurredAtMs: j.optional(j.number())}))});
