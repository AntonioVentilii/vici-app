...
const AppListLeagueBattlesResultSchema = j.strictObject({items: j.array(j.strictObject({id: j.string(), kind: j.enum(['league', 'duel']), side_a: j.string(), side_b: j.string(), proposer: j.string(), state: j.enum(['proposed', 'accepted', 'in_flight', 'resolved']), kickoff_ms: j.number(), settle_ms: j.number(), score_a: j.optional(j.number()), score_b: j.optional(j.number()), winner: j.optional(j.enum(['A', 'B', 'draw']))}))});
...
const AppListMyBattlesResultSchema = j.strictObject({items: j.array(j.strictObject({id: j.string(), kind: j.enum(['league', 'duel']), side_a: j.string(), side_b: j.string(), proposer: j.string(), state: j.enum(['proposed', 'accepted', 'in_flight', 'resolved']), kickoff_ms: j.number(), settle_ms: j.number(), score_a: j.optional(j.number()), score_b: j.optional(j.number()), winner: j.optional(j.enum(['A', 'B', 'draw']))}))});
