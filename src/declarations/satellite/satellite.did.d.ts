...
export interface AppDeleteMyAccountArgs { 'note' : string, 'reason' : string }
...
export interface AppListLeagueBoutsArgs { 'league_id' : string }
...
export interface _SERVICE {
  ...
  'app_list_league_bouts' : ActorMethod<
