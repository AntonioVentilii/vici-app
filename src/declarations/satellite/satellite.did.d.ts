...
export interface AppLookupReferralCodeByHandleArgs { 'handle' : string }
export interface AppLookupReferralCodeByHandleResult { 'code' : [] | [string] }
...
export interface _SERVICE {
  ...
  >,
  'app_lookup_referral_code_by_handle' : ActorMethod<
