...
export interface AppDeleteAnalyticsEventsArgs { 'keys' : Array<string> }
export interface AppDeleteAnalyticsEventsResult { 'deleted' : number }
...
export interface AppGetAnalyticsSummaryArgs { 'days' : number }
...
export interface AppGetAnalyticsUserStatsResult { 'registered' : number }
...
export interface AppGetMonthlyLeaderboardArgs { 'month_anchor' : string }
...
export interface AppGetMyBattleStatsResult { 'bouts_won' : number }
...
export interface AppListFriendResolvedResultsArgs { 'friends' : Array<string> }
...
export interface AppPruneResolvedResultsResult { 'pruned' : number }
export interface AppReadBattleLiveScoreArgs { 'battle_id' : string }
...
export interface AppRecordFlowSwipeArgs { 'day_key' : string }
...
export interface AppResolveBattleArgs { 'battle_id' : string }
...
export interface AppSettleFounderAwardsResult { 'settled' : number }
export interface AppSettleReferralArgs { 'referee' : string }
...
export interface AppSubmitSchoolResult { 'submission_id' : string }
...
export interface AppTrackEventsResult { 'accepted' : number }
...
export interface _SERVICE {
  ...
  >,
  'app_get_analytics_events' : ActorMethod<
  ...
  >,
  'app_get_analytics_user_stats' : ActorMethod<
    [],
    AppGetAnalyticsUserStatsResult
  >,
  'app_get_auth_identities' : ActorMethod<
  ...
  >,
  'app_list_challengeable_leagues' : ActorMethod<
    [],
  ...
  'app_list_friend_recommended_leagues' : ActorMethod<
    [],
  ...
  >,
  'app_rebuild_market_tag_index' : ActorMethod<
    [],
    AppRebuildMarketTagIndexResult
  >,
  'app_recompute_activity_reaction_counts' : ActorMethod<
    [],
    AppRecomputeActivityReactionCountsResult
  >,
  'app_record_flow_swipe' : ActorMethod<
  ...
  'app_reject_friend_request' : ActorMethod<
    ...
    undefined
  >,
  'app_resolve_battle' : ActorMethod<
  ...
  >,
  'app_verify_school_code' : ActorMethod<
