...
export const idlFactory = ({ IDL }) => {
  ...
  const AppLookupReferralCodeByHandleArgs = IDL.Record({ 'handle' : IDL.Text });
  const AppLookupReferralCodeByHandleResult = IDL.Record({
  ...
  return IDL.Service({
    ...
    'app_lookup_referral_code_by_handle' : IDL.Func(
        [AppLookupReferralCodeByHandleArgs],
        [AppLookupReferralCodeByHandleResult],
        ['query'],
      ),
