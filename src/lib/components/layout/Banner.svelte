...
{#if envBannerVisible}
	<div
		class="bg-no text-ink fixed top-0 left-1/2 z-40 mx-auto mt-1 flex w-[calc(100vw-2rem)] max-w-3xl -translate-x-1/2 justify-between gap-4 rounded-xl px-3 py-2 font-extrabold lg:w-[calc(100vw-4rem)] lg:px-6 lg:py-4"
	>
