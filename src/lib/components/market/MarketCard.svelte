...
<div class="h-full" in:fly={{ y: 20, duration: 400, delay: Math.min(index * 50, 300) }}>
	<Card
		class="group h-full overflow-hidden border-none shadow-md transition-all hover:-translate-y-1 hover:shadow-xl"
								...
								<div class="flex flex-col gap-3">
									...
									{#if (market.outcomes?.length ?? 0) > 2}
										<div class="flex items-center justify-center pt-1">
											<span class="text-[10px] font-black tracking-widest text-indigo-500 uppercase"
