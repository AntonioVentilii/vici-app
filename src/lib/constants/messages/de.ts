export const deMessages = {
	...
	'dash.build.sheet_in_play': 'Aktuell im Spiel',
	'dash.build.sheet_invite_cta': 'Freund einladen · +500 VXP je',
	'dash.build.sheet_lifetime': 'Insgesamt verdient',
	'dash.build.sheet_referrals': 'Aus Empfehlungen',
	'dash.build.sheet_referrals_many': '· {count} Freunde',
	'dash.build.sheet_referrals_one': '· {count} Freund',
