export const deMessages = {
	...
	'inbox.market.body.down': 'YES fiel um {pts} Pkt. bei "{market}".',
	'inbox.market.body.up': 'YES stieg um {pts} Pkt. bei "{market}".',
	'inbox.market.title': 'Markt bewegt',
	...
	'onboarding.v3.avail.invalid': 'Nur Buchstaben, Zahlen, . _ -',
	'onboarding.v3.avail.too_short': 'Zu kurz — mindestens 2 Zeichen',
	'onboarding.v3.avail.too_long': 'Zu lang — höchstens 16 Zeichen',
	'onboarding.v3.avail.reserved': 'Reserviert — wähle einen anderen',
	'onboarding.v3.avail.check_failed': 'Prüfung fehlgeschlagen — versuche zu sichern',
	'onboarding.v3.reward_title': '1500-VXP-Starterpaket',
	'onboarding.v3.reward_sub': 'Sag {event} voraus',
	'onboarding.v3.lock_ready': '@{handle} wird gesichert',
	'onboarding.v3.lock_blocked': 'Gib einen verfügbaren Handle ein, um fortzufahren',
	'onboarding.v3.skip': 'Überspringen — erst ansehen, später registrieren',
	'onboarding.v3.signin_prompt': 'Schon dabei?',
	'onboarding.v3.signin_link': 'Anmelden',
	'onboarding.v3.legal_currency': 'VXP ist Spielwährung · kein echtes Geld',
	'onboarding.v3.legal_resolution': 'Auflösung anhand öffentlicher Daten',
