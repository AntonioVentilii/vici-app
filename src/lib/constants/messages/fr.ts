export const frMessages = {
	...
	'account.intro':
		'VICI te connecte avec une passkey — ton Face ID ou ton empreinte — ou avec Internet Identity ou Google. Pas de mot de passe, pas de lien par e-mail. Change de méthode à tout moment — tes données restent.',
