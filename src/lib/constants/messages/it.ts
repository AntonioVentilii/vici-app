export const itMessages = {
	...
	'account.intro':
		'VICI ti fa accedere con una passkey — il tuo Face ID o impronta — oppure con Internet Identity o Google. Niente password, niente link via email. Cambia metodo in qualsiasi momento — i tuoi dati restano.',
