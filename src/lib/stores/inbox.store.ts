 ...
 * then likes received on your calls, then saved-market move alerts, then
 * streak / level milestones. Every card is derived from live data — there is
 * no seeded/mock layer.
 *
