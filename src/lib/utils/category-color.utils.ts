// Per-category chip / accent color. These are the *brand* accents the
// UI uses for category chips, tabs, and hover affordances — NOT the
...
// intentionally diverges so the chip and the artwork read as two
// distinct moments.
//
