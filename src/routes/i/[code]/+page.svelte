<script lang="ts">
	...
	/**
	 * Invite-link landing page — single canonical URL for referral attribution.
	 *
	 * The `[code]` slug is an 8-char Crockford-base32 referral code (the alphabet is enforced by
